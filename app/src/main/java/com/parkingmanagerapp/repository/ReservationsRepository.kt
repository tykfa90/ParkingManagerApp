        ...
        withContext(ioDispatcher) {
            try {
                ...
                val existingReservations =
                    existingReservationsSnapshot.toObjects(Reservation::class.java)
        ...
        withContext(ioDispatcher) {
            try {
                Log.d(
                    ...
                    "Attempting to delete reservation with ID: $reservationID"
                )
                ...
                Log.d(
                    "ReservationsRepository",
                    "Reservation deleted successfully for ID: $reservationID"
                )
                Result.success(true)
            } catch (e: Exception) {
