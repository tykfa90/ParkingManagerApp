...
fun AdminParkingSlotScreen(
    ...
    StandardScreenLayout(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            ...
            val sortedParkingSlots = parkingSlots.sortedBy { it.parkingSlotLabel }
            ...
            LazyColumn(
                ...
                items(sortedParkingSlots) { parkingSlot ->
                    Card(
                        modifier = Modifier
                            .fillMaxWidth()
                ...
                isScrolledToEnd = sortedParkingSlots.size <= 3
            }

            // Scroll indicator to inform admins they can scroll down/up
            if (!isScrolledToEnd && sortedParkingSlots.isNotEmpty()) {
                Box(
                    modifier = Modifier
